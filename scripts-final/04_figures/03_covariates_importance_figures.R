...
ggsave("figures-R3/covariates_importance_all.png", covariates_importance_all, height = 15, width = 11)
...
ggsave("figures-R3/merged_covariates_importance.png", merged_covariates_importance, height = 15, width = 10)
