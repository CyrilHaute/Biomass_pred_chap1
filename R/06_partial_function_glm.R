# function to fit glm and assess covariates partial dependence

partial_function_glm <- function(biomass, 
                                 covariates, 
                                 species_name,
                                 base_dir){
  ...
  model_fit <- glm(formula = model_formula, family = gaussian, data = sp)
